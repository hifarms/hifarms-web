              ...
              <table width="100%">
                  ...
                  <tr>
                      <td style="padding-top: 15px;padding-bottom: 15px;padding-left: 55px;padding-right: 55px;">
                       ...
                       <p style="color: #404a3d;font-size: 20px;font-weight: bold;">You're back in! <img src="{{asset('img/Farmer Icon.svg')}}" alt="farmer-icon" style="margin-right: 5px;margin-left: 2px;" width="33px"></p>
                       <p style="color: #404a3d;font-size: 15px; line-height: 23px;padding: 5px 0 15px;">Your password has been changed as requested. If this 
                        ...
                        <p style="padding-top:5px;">Happy Farming! <img src="{{asset('img/fxemoji_earofmaize.svg')}}" alt="maize" width="19"></p>
