...
<title>Welcome Email</title>    <link rel="shortcut icon" href="{{asset('img/favicon.ico')}}" type="image/x-icon">
              ...
              <table width="100%">
                  ...
                  <tr>
                      <td style="padding-top: 15px;padding-bottom: 15px;padding-left: 55px;padding-right: 55px;">
                       ...
                       <p style="color: #404a3d;font-size: 20px;font-weight: bold;">Welcome to Hi Farms <img src="{{asset('img/Farmer Icon.svg')}}" alt="farmer-icon" style="margin-right: 5px;margin-left: 2px;" width="33px"><img src="{{asset('img/noto_tractor.png')}}" alt="tractor-image" width="33"></p>
                       <p style="color: #404a3d;font-size: 15px; line-height: 23px;padding: 5px 0 15px;">Thanks for creating your account on Hi Farms! 
                        To start investments services and all other agro based
                        services please click the link below to confirm your email.</p>
                       <a style="color: #404a3d;" href="{{url('verify-email?token='.$token)}}">
                        {{url('verify-email?token='.$token)}}</a>
                        <p style="padding-top: 30px;">You will be redirected automatically.</p>
