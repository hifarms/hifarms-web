 ...
 <!--
      <div class="gallery gallery-container">
        <div class="gallery-grid">
           <img src="img/Rectangle 23.png" alt="image" class="grid">
            <img src="img/grassfield@4x 1.png" alt="image" class="grid">
            <img src="img/unsplash_Bbq3H7eGids.png" alt="image" class="grid" >
            <img src="img/unsplash_fQ9X2rPEwq8.png" alt="image" class="grid">
            <img src="img/unsplash_CAA5XShS_No.png" alt="image" class="grid">
            <img src="img/unsplash_s0lkbvtN9K8.png" alt="image" class="grid">
        </div>
    </div>
 -->
...
<div class="row">
    <div class="column">
      <img src="img/grassfield@4x 1.png" onclick="openModal();currentSlide(1)" class="hover-shadow">
    </div>
    <div class="column">
      <img src="img/unsplash_fQ9X2rPEwq8.png" onclick="openModal();currentSlide(2)" class="hover-shadow">
    </div>
    <div class="column">
      <img src="img/Rectangle 23.png" onclick="openModal();currentSlide(3)" class="hover-shadow">
    </div>
    <div class="column">
      <img src="img/grassfield@4x 1.png" onclick="openModal();currentSlide(4)" class="hover-shadow">
    </div>
    <div class="column">
        <img src="img/grassfield@4x 1.png" onclick="openModal();currentSlide(4)" class="hover-shadow">
      </div>
