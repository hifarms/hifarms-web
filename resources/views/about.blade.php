  ...
  <!--About Page starts here-->
   ...
   <div class="about-history">
       ...
       <div class="about-grid">
           <div class="about-showcase" style="color:#6E7A89;">
           ...
           <img src="img/unsplash_IQVFVH0ajag.png" alt="farm-image" width="980">
       </div>
   </div>
   ...
   <div class="what-drives-us">
      <div class="what-drives-us-content">
    ...
    <div class="ui-wahala"><img src="img/Picture2 1.png" alt=""></div>
    <div class="quote">
    ...
    <div class="purpose">
        ...
        <img src="img/unsplash_nKsAB0kH190.png" alt="image">
        </div>
    </div>
    <div class="land-hectre">
        <h1>Land Hectre</h1>
        <h1 class="hectre-line"></h1>
        <div class="land-hectre-img">
            <img src="img/Land hector.png" alt="img" width="526" class="land-img">
        </div>
    </div>
  <!--About page end-->
