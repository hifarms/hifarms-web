                ...
                <table id="datatables">
                    <thead>
                        <tr>
                            ...
                            <th class="all" style="padding-top:10px;padding-bottom:10px;padding-left:20px;padding-right:30px;">Date</th>
                            ...
                            <th class="all" style="padding-top:10px;padding-bottom:10px;padding-left:20px;padding-right:20px;">Annual Return <br>
                                on Investment (₦)</th>
                            <th class="all" style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px;">Withdrawal
                                <br>(₦)
                            </th>
                            <th class="all" style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px;">User ID</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php($counter=0)
